...
class ProductQuantizer(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    d = property(_swigfaiss.ProductQuantizer_d_get, _swigfaiss.ProductQuantizer_d_set, doc=r""" size of the input vectors""")
    ...
    code_size = property(_swigfaiss.ProductQuantizer_code_size_get, _swigfaiss.ProductQuantizer_code_size_set, doc=r""" bytes per indexed vector""")
    ...
    d / M)
    """)
    centroids = property(_swigfaiss.ProductQuantizer_centroids_get, _swigfaiss.ProductQuantizer_centroids_set, doc=r""" Centroid table, size M * ksub * dsub""")
...
class AdditiveQuantizer(object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    d = property(_swigfaiss.AdditiveQuantizer_d_get, _swigfaiss.AdditiveQuantizer_d_set, doc=r""" size of the input vectors""")
    ...
    code_size = property(_swigfaiss.AdditiveQuantizer_code_size_get, _swigfaiss.AdditiveQuantizer_code_size_set, doc=r""" code size in bytes""")
    tot_bits = property(_swigfaiss.AdditiveQuantizer_tot_bits_get, _swigfaiss.AdditiveQuantizer_tot_bits_set, doc=r""" total number of bits""")
    ...
    def set_derived_values(self):
        r""" Train the additive quantizer"""
    ...
    def pack_codes(self, n, codes, packed_codes, ld_codes=-1, norms=None):
        r"""
        ...
        """
        return _swigfaiss.AdditiveQuantizer_pack_codes(self, n, codes, packed_codes, ld_codes, norms)
...
class ResidualQuantizer(AdditiveQuantizer):
    ...
    r""" progressive dim clustering"""
    Train_default_Train_top_beam = _swigfaiss.ResidualQuantizer_Train_default_Train_top_beam
    Train_progressive_dim_Train_top_beam = _swigfaiss.ResidualQuantizer_Train_progressive_dim_Train_top_beam
    Train_default_Skip_codebook_tables = _swigfaiss.ResidualQuantizer_Train_default_Skip_codebook_tables
    Train_progressive_dim_Skip_codebook_tables = _swigfaiss.ResidualQuantizer_Train_progressive_dim_Skip_codebook_tables
    Train_default_Train_top_beam_Skip_codebook_tables = _swigfaiss.ResidualQuantizer_Train_default_Train_top_beam_Skip_codebook_tables
    Train_progressive_dim_Train_top_beam_Skip_codebook_tables = _swigfaiss.ResidualQuantizer_Train_progressive_dim_Train_top_beam_Skip_codebook_tables
    ...
    max_mem_distances = property(_swigfaiss.ResidualQuantizer_max_mem_distances_get, _swigfaiss.ResidualQuantizer_max_mem_distances_set, doc=r"""
...
class IndexAdditiveQuantizer(IndexFlatCodes):
    ...
    def search(self, n, x, k, distances, labels):
        return _swigfaiss.IndexAdditiveQuantizer_search(self, n, x, k, distances, labels)
...
class AdditiveCoarseQuantizer(Index):
    ...
    def search(self, n, x, k, distances, labels):
        return _swigfaiss.AdditiveCoarseQuantizer_search(self, n, x, k, distances, labels)
...
class IVFSearchParameters(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    nprobe = property(_swigfaiss.IVFSearchParameters_nprobe_get, _swigfaiss.IVFSearchParameters_nprobe_set, doc=r""" number of probes at query time""")
    max_codes = property(_swigfaiss.IVFSearchParameters_max_codes_get, _swigfaiss.IVFSearchParameters_max_codes_set, doc=r""" max nb of codes to visit to do a query""")
...
class ScalarQuantizer(object):
    ...
    d = property(_swigfaiss.ScalarQuantizer_d_get, _swigfaiss.ScalarQuantizer_d_set, doc=r""" dimension of input vectors""")
    bits = property(_swigfaiss.ScalarQuantizer_bits_get, _swigfaiss.ScalarQuantizer_bits_set, doc=r""" bits per scalar code""")
    code_size = property(_swigfaiss.ScalarQuantizer_code_size_get, _swigfaiss.ScalarQuantizer_code_size_set, doc=r""" bytes per vector""")
...
class IndexIVFAdditiveQuantizer(IndexIVF):
    ...
    def get_InvertedListScanner(self, store_pairs):
        return _swigfaiss.IndexIVFAdditiveQuantizer_get_InvertedListScanner(self, store_pairs)
...
class IndexIVFPQFastScan(IndexIVF):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    by_residual = property(_swigfaiss.IndexIVFPQFastScan_by_residual_get, _swigfaiss.IndexIVFPQFastScan_by_residual_set, doc=r""" Encode residual or plain vector?""")
    ...
    orig_invlists = property(_swigfaiss.IndexIVFPQFastScan_orig_invlists_get, _swigfaiss.IndexIVFPQFastScan_orig_invlists_set, doc=r""" orig's inverted lists (for debugging)""")
...
class IDSelector(object):
    r""" Encapsulates a set of ids to remove."""
...
class IDSelectorRange(IDSelector):
    r""" remove ids between [imni, imax)"""
